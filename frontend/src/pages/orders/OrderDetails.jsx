  ...
  const handleCancelOrder = async () => {
    ...
    try {
      const { data } = await axios.put(
        `https://prod-ecom-backend.onrender.com/api/orders/${id}/cancel`,
        {},
        { withCredentials: true }
      );
      setOrder(data);
          ...
          <div className="p-6 border-b border-gray-100 bg-gray-50/50">
            ...
            {canCancelOrder(order.status) && (
              <button
                ...
                className="mt-5 w-full sm:w-auto bg-red-50 text-red-600 border border-red-200 hover:bg-red-100 px-5 py-2.5 rounded-xl font-semibold transition-colors"
              >
                Cancel Order
              </button>
            )}
